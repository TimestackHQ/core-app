...
class TimestackCoreModule : Module() {
  ...
  override fun definition() = ModuleDefinition {
    ...
    // The module will be accessible from `requireNativeModule('TimestackCore')` in JavaScript.
    Name("TimestackCore")
    ...
    View(TimestackCoreView::class) {
      // Defines a setter for the `name` prop.
      Prop("name") { view: TimestackCoreView, prop: String ->
        println(prop)
      }
    }
  }
